...
let s:p.normal.middle = [ [ '#000000', '#d6d6d6' ] ]
...
let s:p.tabline.middle = [ [ '#121212', '#d6d6d6' ] ]
let s:p.tabline.right = [ [ '#ffffff', '#005fff' ] ]

let g:lightline#colorscheme#Intellij_Light#palette = lightline#colorscheme#fill(s:p)
