...
call s:h("gitcommitSelectedType", s:green3, s:color0, s:none)
call s:h("gitcommitSelectedFile", s:green3, s:color0, s:none)
...
call s:h('gitcommitSummary', s:pink0, s:color0, s:none)
call s:h('gitcommitBlank', s:pink0, s:color0, s:none)
